...
int main()
{
	...
	strcpy(LocationArr[0].latitudeStr,tempArr[2].tempStr);
	strcpy(LocationArr[0].longitudeStr,tempArr[4].tempStr);
	strcpy(LocationArr[0].altitudeStr,tempArr[9].tempStr);	
	
	printf("latitude is %s\n",LocationArr[0].latitudeStr);
	printf("longitude is %s\n",LocationArr[0].longitudeStr);
	printf("altitude %s\n",LocationArr[0].altitudeStr);	
